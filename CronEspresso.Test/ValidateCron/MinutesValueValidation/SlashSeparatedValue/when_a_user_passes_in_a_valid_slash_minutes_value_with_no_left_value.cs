...
namespace CronEspresso.Test.ValidateCron.MinutesValueValidation.SlashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_valid_slash_minutes_value_with_no_left_value
    {
