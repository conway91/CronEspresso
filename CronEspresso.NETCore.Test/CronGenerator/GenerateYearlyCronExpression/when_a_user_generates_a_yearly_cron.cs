...
namespace CronEspresso.NETCore.Test.CronGenerator.GenerateYearlyCronExpression
{
    public class when_a_user_generates_a_yearly_cron
    {
        ...
        private readonly MonthOfYear _feburaryEnum = MonthOfYear.February;
        ...
        [Test]
        public void it_can_run_on_the_last_day_of_feburary_enum()
        {
