...
namespace CronEspresso.NETCore.Test.ValidateCron.HoursValueValidation.SlashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_valid_slash_hours_value_with_no_left_value
    {
        private const string CronValue = "* * /23 * * *";
