...
namespace CronEspresso.NETCore.Test.ValidateCron.HoursValueValidation.CommaSeparated
{
    [TestFixture]
    public class when_a_user_passes_in_a_comma_hours_value_with_trailing_comma
    {
