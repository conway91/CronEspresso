...
namespace CronEspresso.NETCore.Test.ValidateCron.DayOfMonthValueValidation.CommaSeparated
{
    [TestFixture]
    public class when_a_user_passes_in_a_comma_dom_value_with_higher_max_value
    {
        private const string CronValue = "* * * 1,12,32 * *";
