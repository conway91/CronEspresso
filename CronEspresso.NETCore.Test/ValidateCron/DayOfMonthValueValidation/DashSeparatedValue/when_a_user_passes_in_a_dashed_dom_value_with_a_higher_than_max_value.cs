...
namespace CronEspresso.NETCore.Test.ValidateCron.DayOfMonthValueValidation.DashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_dashed_dom_value_with_a_higher_than_max_value
    {
        private const string CronValue = "* * * 1-32 * *";
