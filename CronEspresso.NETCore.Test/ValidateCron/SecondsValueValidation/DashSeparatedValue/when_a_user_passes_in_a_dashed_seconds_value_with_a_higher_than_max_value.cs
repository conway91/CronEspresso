...
namespace CronEspresso.NETCore.Test.ValidateCron.SecondsValueValidation.DashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_dashed_seconds_value_with_a_higher_than_max_value
    {
