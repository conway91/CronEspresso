...
namespace CronEspresso.NETCore.Test.ValidateCron.SecondsValueValidation.SlashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_slash_seconds_value_with_a_higher_left_value
    {
