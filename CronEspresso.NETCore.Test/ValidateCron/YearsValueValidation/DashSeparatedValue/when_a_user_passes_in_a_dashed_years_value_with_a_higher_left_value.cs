...
namespace CronEspresso.NETCore.Test.ValidateCron.YearsValueValidation.DashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_dashed_years_value_with_a_higher_left_value
    {
        private const string CronValue = "* * * * * * 2012-2011";
