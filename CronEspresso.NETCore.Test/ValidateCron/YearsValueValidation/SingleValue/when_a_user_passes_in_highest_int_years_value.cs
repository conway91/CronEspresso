...
namespace CronEspresso.NETCore.Test.ValidateCron.YearsValueValidation.SingleValue
{
    [TestFixture]
    public class when_a_user_passes_in_highest_int_years_value
    {
        private const string CronValue = "* * * * * * 2099";
