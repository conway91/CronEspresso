...
namespace CronEspresso.NETCore.Test.ValidateCron.DayOfWeekValueValidation.StringSlashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_slash_dow_string_value_with_invalid_right
    {
        private const string CronValue = "* * * * * MON/GIBBERISH";
