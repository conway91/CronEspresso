...
namespace CronEspresso.NETCore.Test.ValidateCron.DayOfWeekValueValidation.IntSlashSeparatedValue
{
    [TestFixture]
    public class when_a_user_passes_in_a_slash_dow_value_with_multiple_slashes
    {
        private const string CronValue = "* * * * * 2//3";
