...
namespace CronEspresso.NETCore.Test.ValidateCron.MinutesValueValidation.CommaSeparated
{
    [TestFixture]
    public class when_a_user_passes_in_a_comma_minutes_value_with_higher_max_value
    {
        private const string CronValue = "* 31,32,60 * * * *";
